...
{
  */
int GeoStarsFunc:: geoMag( double alt,    double glat,  double glon,  double time,
...
int GeoStarsFunc:: geomg1( double  alt, double glat, double glon, double time,
			double *dec, double *dip, double *ti,  double *gv)
{
...
\param double dec   :out: declination in degrees
*/
int GeoStarsFunc:: geoMagGetDec(double lat, double lon, double hgt,
...
*/
double GeoStarsFunc:: geoMagGetDecRet(double lat, double lon, double hgt,
...
\retval double dec   :out: declination in degrees
*/
double GeoStarsFunc:: geoMagGetDecNow(double lat, double lon, double hgt)
{
	struct tm *newtime;
    time_t aclock;
	double dec;
...
int GeoStarsFunc:: geoMagFillDec(GEO_LOCATION *l, double *dec)
{
	struct tm *newtime;
    time_t aclock;
