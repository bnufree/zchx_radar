///**************************************************************************
//* @File: geoPoint.cpp
//* @Description:  坐标转换， 极坐标和笛卡尔坐标之间转换
...
void    GeoStarsFunc:: geoEfg2Llh( int datum,  double efg[],
...
int GeoStarsFunc:: geoEfg2XyzDiff( GEO_LOCATION *src_desc,
...
double  GeoStarsFunc:: geoLlh2DiffX( double lat1, double lon1, double hgt1, int datum1, double lat2, double lon2, double hgt2, int datum2 )
{
    double xyz[3];
...
double  GeoStarsFunc:: geoLlh2DiffY( double lat1, double lon1, double hgt1, int datum1, double lat2, double lon2, double hgt2, int datum2 )
{
    double xyz[3];
    GEO_LOCATION site1, site2;
    geoInitLocation( &site1, lat1, lon1, hgt1, datum1,  "site1" );
...
double  GeoStarsFunc:: geoLlh2DiffZ( double lat1, double lon1, double hgt1, int datum1, double lat2, double lon2, double hgt2, int datum2 )
{
    double xyz[3];
    GEO_LOCATION site1, site2;
    geoInitLocation( &site1, lat1, lon1, hgt1, datum1,  "site1" );
...
void   GeoStarsFunc::  geoLlh2Efg( double lat, double lon, double height, int datum,
...
double   GeoStarsFunc::  geoLlh2E( double lat, double lon, double hgt, int datum )
...
double   GeoStarsFunc::  geoLlh2F( double lat, double lon, double hgt, int datum )
...
double   GeoStarsFunc::  geoLlh2G( double lat, double lon, double hgt, int datum )
...
void GeoStarsFunc:: geoXyz2Rae( double xyz_in[],
                              double rae_out[] )
{
    double horz_dist;
    /* Determine the range: */
...
*/
double  GeoStarsFunc:: geoXyz2R( double x, double y, double z )
{
    double rae[3], xyz[3];
    xyz[0] = x;
    xyz[1] = y;
...
*/
double  GeoStarsFunc:: geoXyz2A( double x, double y, double z )
{
    double rae[3], xyz[3];
    xyz[0] = x;
    xyz[1] = y;
...
double  GeoStarsFunc:: geoXyz2E( double x, double y, double z )
{
    double rae[3], xyz[3];
    xyz[0] = x;
    xyz[1] = y;
...
\brief This routine converts from Range, Azimuth, and Elevation
 ...
 \return nothing
*/
void GeoStarsFunc:: geoRae2Xyz( double rae_in[],
                              double xyz_out[] )
{
    double r_cos_e;
...
void GeoStarsFunc:: geoRae2Efg( GEO_LOCATION *loc,
                              double aer_in[],
                              double efg_out[] )
{
    double c1, c2, c3;
...
\return radians
*/
double  GeoStarsFunc:: geoDms2Rads( double deg, double min, double sec, char *sign )
{
    double direction;
...
*/
double  GeoStarsFunc:: geoDms2DD( double deg, double min, double sec, char *sign )
{
    double direction;
...
\return radians
*/
double GeoStarsFunc:: geoDecdms2Rads( double in )     /* minutes and seconds */
{
...
void  GeoStarsFunc:: geoRads2Dms( double rads,
 ...
 */
double GeoStarsFunc:: geoRads2Decdms( double rads )
{
    double d, m, s, sign;
    double frac;
...
double  GeoStarsFunc:: geoRads2DD( double rads )
{
...
double  GeoStarsFunc:: geoDD2Rads( double dd )
{
...
void  GeoStarsFunc:: geoDD2Dms( double dd,
                              double *deg, double *min, double *sec, double *dir )
{
    double temp;
    double fraction;
