...
//AIS基站
class ZCHX_ECDIS_EXPORT AISChartElement : public FixElement<ZCHX::Data::ITF_AIS_Chart>
{

public:
    explicit AISChartElement(const ZCHX::Data::ITF_AIS_Chart &data, zchxMapWidget* w)
    :FixElement<ZCHX::Data::ITF_AIS_Chart>(data, ZCHX::Data::ELE_AIS_CHART, ZCHX::LAYER_AIS_CHART, w) {}
    void drawElement(QPainter *painter) ;
    void setData(const ZCHX::Data::ITF_AIS_Chart &data);
private:
