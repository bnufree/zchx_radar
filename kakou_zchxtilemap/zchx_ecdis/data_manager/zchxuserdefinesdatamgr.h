...
public:
    explicit zchxWarningZoneDataMgr(zchxMapWidget* w, QObject *parent = 0):
        zchxTemplateDataMgr<WarningZoneElement, ZCHX::Data::ITF_WarringZone>(w, ZCHX::DATA_MGR_WARNING_ZONE, ZCHX::LAYER_DEFINEZONE, parent) {}
...
class zchxStatistcLineDataMgr : public zchxTemplateDataMgr<StatistcLineElement, ZCHX::Data::ITF_StatistcLine>
{
public:
    explicit zchxStatistcLineDataMgr(zchxMapWidget* w, QObject *parent = 0):
        zchxTemplateDataMgr<StatistcLineElement, ZCHX::Data::ITF_StatistcLine>(w, ZCHX::DATA_MGR_STATISTCLINE, ZCHX::LAYER_STATISTCLINE, parent) {}
    virtual void importData(const std::vector<std::pair<double, double> > & path);
    bool updateActiveItem(const QPoint &pt);
};
...
class zchxAisChartDataMgr : public zchxTemplateDataMgr<AISChartElement, ZCHX::Data::ITF_AIS_Chart>
{
public:
    explicit zchxAisChartDataMgr(zchxMapWidget* w, QObject *parent = 0):
        zchxTemplateDataMgr<AISChartElement, ZCHX::Data::ITF_AIS_Chart>(w, ZCHX::DATA_MGR_AIS_CHART, ZCHX::LAYER_AIS_CHART, parent){}
