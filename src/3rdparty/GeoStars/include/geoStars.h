///**************************************************************************
//* @File: geoStars.h
//* @Description:  地理库的所有定义函数接口
//*  This file has all of the definitions for the Geo Library:
//* geoEllips, geoPoint, and geoMag.
...
\li \b geoEllips.cpp - Ellipsoid definitions and location descriptor routines
\li \b geoPoint.cpp - Coordinate transformations, polar and Cartesian conversions
\li \b geoMag.cpp - Geo Magnetism routines for the World Magnetism Model of 2005
...
class ZCHX_API GeoStarsFunc {
public:
    ~GeoStarsFunc();
    static GeoStarsFunc *instance();

    /* geoEllips function */
    void    geoGetEllipsoid(double *a,double *b,double *e2,double *ee2,double *f,int datum);
    int     geoInitLocation(GEO_LOCATION *l, double lat, double lon, double hgt, int datum,  const char *name);
    /* geoPoint functions */
...
private:
    explicit GeoStarsFunc();
    static GeoStarsFunc *m_instance;
};

#define     GeoIns              GeoStarsFunc::instance()
