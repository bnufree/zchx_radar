///**************************************************************************
//* @File: geoEllips.cpp
//* @Description:  地球椭球体定义和地理位置描述符例程
//*  This file contains geo library location setup and initialization
...
int GeoStarsFunc:: geoInitLocation(GEO_LOCATION *l, double lat, double lon, double hgt, int datum,  const char *name)
{
...
void    GeoStarsFunc:: geoGetEllipsoid(double *a,double *b,double *e2,double *ee2,double *f,int datum)
{
     /* - Major Axis. */
     *a   = ellips[datum].a;
