...
class zchxDrawStatistcLineTool: public zchxDrawZoneTool
{
    Q_OBJECT
public:
    explicit zchxDrawStatistcLineTool(zchxMapWidget* w, QObject *parent = 0):
        zchxDrawZoneTool(w, qt::eTool::STATISTCLINEMANAGER, 3, parent) {}
    void show(QPainter *painter);
    void endDraw();
