...
ZCHX_ECDIS_PATH = $${ZCHX_3RD_PATH}/$${ZCHX_ECDIS_NAME}/$${ZCHX_ECDIS_VERSION}
...
# 安装翻译文件
    ...
    ZCHX_ECDIS_translation.path =  $$IDE_APP_PATH/translations/
    INSTALLS += ZCHX_ECDIS_translation

# 安装资源文件
    ZCHX_ECDIS_resource.files = $${ZCHX_ECDIS_PATH}/resources/*.rcc
    ZCHX_ECDIS_resource.path = $$IIDE_APP_PATH/translations/resource/
INSTALLS += ZCHX_ECDIS_resource

#安装补丁文件
    ZCHX_ECDIS_patch.files = $${ZCHX_ECDIS_PATH}/bin/mapdata/*
    ZCHX_ECDIS_patch.path = $${IDE_APP_PATH}/mapdata/

    INSTALLS += ZCHX_ECDIS_patch
