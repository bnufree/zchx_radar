...
class zchxMapWidget : public QWidget
{
    Q_OBJECT
public:
    explicit zchxMapWidget(zchxDataMgrFactory *dataMgrFactory, QWidget *parent = 0);
    ~zchxMapWidget();
...
//    //防区操作
    ...
    //自定义线
    void setETool2Draw4StatistcLineArea();
    void setETool2SelectStatistcLine();                 //选取当前自定义线
    void setETool2moveStatistcLine();                   //移动选中的自定义线
    void setETool2ctrlStatistcLine();                   //微调控制点
    void setETool2addCtrlStatistcLine();                //添加控制点
    void setETool2delCtrlStatistcLine();                //删除控制点
...
signals: //发送外部信号
    ...
    void signalIsSelected4StatistcLineZone(const ZCHX::Data::ITF_StatistcLine &info);//选中的自定义线
    ...
    void signalIsDoubleClicked4StatistcLineZone(const ZCHX::Data::ITF_StatistcLine &info);//双击自定义线
    ...
    void signalPlayDirectVhfText(QString shipId);
