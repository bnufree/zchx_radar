...
double Utils::getDistanceDeg(double lat1, double lon1, double lat2, double lon2)
{
    double* course1 = NULL;
    double* course2 = NULL;
...
int Utils::getVesselType(const int uTypeID)
{
    int TypeId = uTypeID;
    int VesselType = 0;
//    if(uTypeID == 30) //渔船
...
//        VesselType = 1;
//    }
//    else if(uTypeID == 60 || uTypeID > 64 && uTypeID < 70)//客船
//    {
//       VesselType = 2;
//    }
//    else if(uTypeID == 70 || (uTypeID < 80 && uTypeID > 74))//货船
//    {
//       VesselType = 3;
//    }
//    else if(uTypeID == 80 || (uTypeID < 90 && uTypeID > 84))//油轮
//    {
//       VesselType = 4;
//    }
//    else if((uTypeID > 40 && uTypeID < 45) ||
//            (uTypeID > 70 && uTypeID < 75) ||
//            (uTypeID > 80 && uTypeID < 85) ||
//            (uTypeID > 90 && uTypeID < 95) ||
//            (uTypeID > 20 && uTypeID < 25))//危险品
//    {
//       VesselType = 5;
//    }
    ...
    else if((TypeId == 80) || ((84<TypeId)&&(TypeId<90)))//油轮
    {
        VesselType = 4;
    }
    else if((TypeId == 60) || (64<TypeId)&&(TypeId<70))  //客船
    {
        VesselType = 2;
    }
    else if((TypeId == 70 ) ||  (74<TypeId)&&(TypeId<80)) //货船
    {
        VesselType = 3;
    }
    else    //  其他船
