...
//    else
//    {
        ui->lineEdit_7->setText(file_name);
//    }
    Utils::Profiles::instance()->setValue(str_radar,"Limit_File", file_name);
}
//1_实时打印接收到的雷达状态信息
...
void zchxradarinteface::on_outputRoutePathChk_clicked(bool checked)
{
    output_route_path = checked;
}

void zchxradarinteface::on_pause_moni_clicked()
{
    if(up_video)
    {
        up_video->setIsOver(true);
    }
}

void zchxradarinteface::on_restart_moni_clicked()
{
