...
void protobuf_AssignDesc_ZCHXRadarVideo_2eproto() {
  ...
  static const int RouteNode_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RouteNode, topnode_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RouteNode, pathlist_),
  };
  ...
  static const int RouteNodes_offsets_[1] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RouteNodes, nodes_),
  };
  ...
  static const int RadarRect_offsets_[4] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RadarRect, dirconfirmed_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RadarRect, estcount_),
  };
  ...
  static const int RadarRects_offsets_[3] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(RadarRects, rects_),
  };
...
void protobuf_AddDesc_ZCHXRadarVideo_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "henhaixin.proto.RadarRectDef\"y\n\tRouteNod"
    "e\0226\n\007topNode\030\001 \002(\0132%.com.zhichenhaixin.p"
    "roto.RadarRectDef\0224\n\010pathlist\030\002 \003(\0132\".co"
    "m.zhichenhaixin.proto.RoutePath\"\?\n\nRoute"
    "Nodes\0221\n\005nodes\030\001 \003(\0132\".com.zhichenhaixin"
    ".proto.RouteNode\"\254\001\n\tRadarRect\022:\n\013curren"
    "tRect\030\001 \002(\0132%.com.zhichenhaixin.proto.Ra"
    "darRectDef\022;\n\014historyRects\030\002 \003(\0132%.com.z"
    "hichenhaixin.proto.RadarRectDef\022\024\n\014dirCo"
    "nfirmed\030\003 \002(\010\022\020\n\010estcount\030\004 \002(\r\"\\\n\nRadar"
    "Rects\022\013\n\003UTC\030\001 \002(\004\022\016\n\006length\030\002 \002(\005\0221\n\005re"
    "cts\030\003 \003(\0132\".com.zhichenhaixin.proto.Rada"
    "rRect\"\363\001\n\nRadarVideo\022\017\n\007radarId\030\001 \002(\004\022\021\n"
    "\tradarName\030\002 \002(\t\022\020\n\010latitude\030\003 \002(\001\022\021\n\tlo"
    "ngitude\030\004 \002(\001\022\013\n\003UTC\030\005 \002(\004\022\021\n\timageData\030"
    "\006 \002(\014\022\024\n\014curImageData\030\007 \002(\014\022\024\n\014preImageD"
    "ata\030\010 \002(\014\022\r\n\005width\030\t \002(\r\022\016\n\006height\030\n \002(\r"
    "\022\016\n\006radius\030\013 \002(\001\022\020\n\010curIndex\030\014 \002(\r\022\017\n\007lo"
    "opNum\030\r \002(\r\"\321\001\n\017RadarVideoPoint\022\021\n\tradar"
    ...
    "height\030\t \002(\r\022\016\n\006radius\030\n \002(\001\022\020\n\010curIndex"
    "\030\013 \002(\r\022\017\n\007loopNum\030\014 \002(\r", 1863);
...
void RouteNode::InitAsDefaultInstance() {
  topnode_ = const_cast< ::com::zhichenhaixin::proto::RadarRectDef*>(&::com::zhichenhaixin::proto::RadarRectDef::default_instance());
}
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (tag == 10) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
               input, mutable_topnode()));
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(18)) goto parse_pathlist;
        break;
      }
...
void RouteNode::MergeFrom(const RouteNode& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_topnode()) {
      mutable_topnode()->::com::zhichenhaixin::proto::RadarRectDef::MergeFrom(from.topnode());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
...
bool RouteNode::IsInitialized() const {
  ...
  if (has_topnode()) {
    if (!this->topnode().IsInitialized()) return false;
  }
  if (!::google::protobuf::internal::AllAreInitialized(this->pathlist())) return false;
  return true;
}
...
#ifndef _MSC_VER
const int RouteNodes::kNodesFieldNumber;
#endif  // !_MSC_VER
...
const int RadarRect::kHistoryRectsFieldNumber;
const int RadarRect::kDirConfirmedFieldNumber;
const int RadarRect::kEstcountFieldNumber;
#endif  // !_MSC_VER
...
void RadarRect::InitAsDefaultInstance() {
  currentrect_ = const_cast< ::com::zhichenhaixin::proto::RadarRectDef*>(&::com::zhichenhaixin::proto::RadarRectDef::default_instance());
}
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (tag == 10) {
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
               input, mutable_currentrect()));
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(18)) goto parse_historyRects;
        break;
      }
      ...
      case 2: {
        if (tag == 18) {
         parse_historyRects:
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
                input, add_historyrects()));
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(18)) goto parse_historyRects;
        if (input->ExpectTag(24)) goto parse_dirConfirmed;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(32)) goto parse_estcount;
        break;
      }
...
void RadarRect::SerializeWithCachedSizes(
  ...
  if (has_currentrect()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      1, this->currentrect(), output);
  }

  // repeated .com.zhichenhaixin.proto.RadarRectDef historyRects = 2;
  for (int i = 0; i < this->historyrects_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      2, this->historyrects(i), output);
  }

  // required bool dirConfirmed = 3;
  if (has_dirconfirmed()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(3, this->dirconfirmed(), output);
  }

  // required uint32 estcount = 4;
  if (has_estcount()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(4, this->estcount(), output);
  }
...
::google::protobuf::uint8* RadarRect::SerializeWithCachedSizesToArray(
  ...
  for (int i = 0; i < this->historyrects_size(); i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
        2, this->historyrects(i), target);
  }

  // required bool dirConfirmed = 3;
  if (has_dirconfirmed()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(3, this->dirconfirmed(), target);
  }

  // required uint32 estcount = 4;
  if (has_estcount()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(4, this->estcount(), target);
  }
...
int RadarRect::ByteSize() const {
  ...
  // repeated .com.zhichenhaixin.proto.RadarRectDef historyRects = 2;
  total_size += 1 * this->historyrects_size();
  for (int i = 0; i < this->historyrects_size(); i++) {
    total_size +=
      ::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(
        this->historyrects(i));
...
void RadarRect::MergeFrom(const RadarRect& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_currentrect()) {
      mutable_currentrect()->::com::zhichenhaixin::proto::RadarRectDef::MergeFrom(from.currentrect());
    }
    if (from.has_dirconfirmed()) {
      set_dirconfirmed(from.dirconfirmed());
    }
    if (from.has_estcount()) {
      set_estcount(from.estcount());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
...
bool RadarRect::IsInitialized() const {
  ...
  if (has_currentrect()) {
    if (!this->currentrect().IsInitialized()) return false;
  }
  if (!::google::protobuf::internal::AllAreInitialized(this->historyrects())) return false;
  return true;
}

void RadarRect::Swap(RadarRect* other) {
  if (other != this) {
    std::swap(currentrect_, other->currentrect_);
    historyrects_.Swap(&other->historyrects_);
    std::swap(dirconfirmed_, other->dirconfirmed_);
    std::swap(estcount_, other->estcount_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
...
const int RadarRects::kRectsFieldNumber;
#endif  // !_MSC_VER
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(26)) goto parse_rects;
        break;
      }
