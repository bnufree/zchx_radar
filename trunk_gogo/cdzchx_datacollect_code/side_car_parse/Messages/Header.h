...
public:
    ...
    */
    ...
    /** Get the globally-unique ID of the message. A GUID contains a unique sequence number given to it by the
        ...
        \return unique ID
    */
    const GGUID& getGloballyUniqueID() const { return guid_; }
    ...
    */
    ...
    virtual void load(const VideoFrame& frame);
...
private:
    ...
    */
    ...
    ZCHX::Messages::GGUID guid_;                ///< Globally-unique ID for this object
