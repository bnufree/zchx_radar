...
public:
    ...
    */
    ...
    {
        return M_PI * 2.0 * shaftEncoding / ( (getShaftEncodingMax() + 1)/2 );
    }
    ...
    */
    ...
    void   setSiteLat(double val) {mLat = val;}
    ...
    */
    double getSiteLong() {return mLon;}
     void   setSiteLon(double val) {mLon = val;}
    ...
    */
    ...
    void   setSiteHeight(double val) {mHeight = val;}
    ...
    */
    ...
    int     getParseMode() {return mParseMode;}
    void    setParseMode(int mode) {mParseMode = mode;}

    void    setExtractionMaxBin(int val) {mExtractionMaxBin = val;}
    int     getExtractionMaxBin() {return mExtractionMaxBin;}

    void    setExtractionMaxAmz(double val) {mExtractionMaxAmz = val;}
    double  getExtractionMaxAmz() {return mExtractionMaxAmz;}

    void    setDiscardExtractionMaxBin(int val) {mDiscardExtractionMaxBin = val;}
    int     getDiscardExtractionMaxBin() {return mDiscardExtractionMaxBin;}

    void    setDiscardExtractionMaxAmz(double val) {mDiscardExtractionMaxAmz = val;}
    double  getDiscardExtractionMaxAmz() {return mDiscardExtractionMaxAmz;}

    void    setCorratedRadius(double val) {mCorratedRadius = val;}
    double  getCorratedRadius() {return mCorratedRadius;}

    void    setCorratedScansNum(int val) {mCorratedScansNum = val;}
    int     getCorratedScansNum() {return mCorratedScansNum;}

    void    setTargetSearchRadius(double val) {mTargetSearchRadius = val;}
    double  getTargetSearchRadius() {return mTargetSearchRadius;}

    void    setTargetMaxInitRotationCount(double val) {mTargetMaxInitRotationCount = val;}
    double  getTargetMaxInitRotationCount() {return mTargetMaxInitRotationCount;}

    void    setTargetMaxCoastRotationCount(double val) {mTargetMaxCoastRotationCount = val;}
    double  getTargetMaxCoastRotationCount() {return mTargetMaxCoastRotationCount;}

    void    setThresholdMode(int mode) {mThresholdMode = mode;}
    int     getThresholdMode() {return mThresholdMode;}

    void    setConstantHoldValue(int val) {mConstantHoldValue = val;}
    int     getConstantHoldValue() {return mConstantHoldValue;}

    void    setOscfarWidowSize(int val) {mOscfarWidowSize = val;}
    int     getOscfarWidowSize() {return mOscfarWidowSize;}

    void    setOscfarAlphaCoeff(double val) {mOscfarAlphaCoeff = val;}
    double    getOscfarAlphaCoeff() {return mOscfarAlphaCoeff;}

    void    setOscfarThresHoldIndex(int val) {mOscfarThresHoldIndex = val;}
    int     getOscfarThresHoldIndex() {return mOscfarThresHoldIndex;}

    double  getMergeRadius() const {return mMergeRadius;}
    void    setMergeRadius(double val) {mMergeRadius = val;}

    double  getMergeAzimuth() const {return mMergeAzimuth;}
    void    setMergeAzimuth(double val) {mMergeAzimuth = val;}
...
private:
    ...
    */
    ...
    int                         mParseMode;         //1:雷达系统自带的库或者周老师的库（第三方库） 2:ZCHX解析库


    static QStringList          gRadarNameList;

    int                         mExtractionMaxBin;
    double                      mExtractionMaxAmz;
    int                         mDiscardExtractionMaxBin;
    double                      mDiscardExtractionMaxAmz;
    double                      mCorratedRadius;
    int                         mCorratedScansNum;
    double                      mTargetSearchRadius;
    double                      mTargetMaxInitRotationCount;
    double                      mTargetMaxCoastRotationCount;
    //模数01转换的设定
    int                         mThresholdMode;     //0:固定阈值;1:OSCFAR
    int                         mConstantHoldValue;
    int                         mOscfarWidowSize;
    double                         mOscfarAlphaCoeff;
    int                         mOscfarThresHoldIndex;

    //目标合并参数设定
    double                      mMergeRadius;           //距离差
    double                      mMergeAzimuth;          //方位差
};
