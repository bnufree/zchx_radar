...
class TrackPointList : public ::google::protobuf::Message {
 public:
  TrackPointList();
  virtual ~TrackPointList();

  TrackPointList(const TrackPointList& from);

  inline TrackPointList& operator=(const TrackPointList& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const TrackPointList& default_instance();

  void Swap(TrackPointList* other);

  // implements Message ----------------------------------------------

  TrackPointList* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const TrackPointList& from);
  void MergeFrom(const TrackPointList& from);
  void Clear();
  bool IsInitialized() const;
  ...
  inline void clear_tracks();
  static const int kTracksFieldNumber = 1;
  inline const ::com::zhichenhaixin::proto::TrackPoint& tracks(int index) const;
  inline ::com::zhichenhaixin::proto::TrackPoint* mutable_tracks(int index);
  inline ::com::zhichenhaixin::proto::TrackPoint* add_tracks();
  ...
  // @@protoc_insertion_point(class_scope:com.zhichenhaixin.proto.TrackPointList)
 private:
  ...
  ::google::protobuf::uint32 _has_bits_[1];
  mutable int _cached_size_;
  ::google::protobuf::RepeatedPtrField< ::com::zhichenhaixin::proto::TrackPoint > tracks_;
  friend void  protobuf_AddDesc_ZCHXRadar_2eproto();
  friend void protobuf_AssignDesc_ZCHXRadar_2eproto();
  friend void protobuf_ShutdownFile_ZCHXRadar_2eproto();

  void InitAsDefaultInstance();
  static TrackPointList* default_instance_;
};
// -------------------------------------------------------------------
...
// repeated .com.zhichenhaixin.proto.TrackPoint tracks = 1;
inline int TrackPointList::tracks_size() const {
  return tracks_.size();
}
inline void TrackPointList::clear_tracks() {
  tracks_.Clear();
}
inline const ::com::zhichenhaixin::proto::TrackPoint& TrackPointList::tracks(int index) const {
  // @@protoc_insertion_point(field_get:com.zhichenhaixin.proto.TrackPointList.tracks)
  return tracks_.Get(index);
}
inline ::com::zhichenhaixin::proto::TrackPoint* TrackPointList::mutable_tracks(int index) {
  // @@protoc_insertion_point(field_mutable:com.zhichenhaixin.proto.TrackPointList.tracks)
  return tracks_.Mutable(index);
}
inline ::com::zhichenhaixin::proto::TrackPoint* TrackPointList::add_tracks() {
  // @@protoc_insertion_point(field_add:com.zhichenhaixin.proto.TrackPointList.tracks)
  return tracks_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::com::zhichenhaixin::proto::TrackPoint >&
TrackPointList::tracks() const {
  // @@protoc_insertion_point(field_list:com.zhichenhaixin.proto.TrackPointList.tracks)
  return tracks_;
}
inline ::google::protobuf::RepeatedPtrField< ::com::zhichenhaixin::proto::TrackPoint >*
TrackPointList::mutable_tracks() {
  // @@protoc_insertion_point(field_mutable_list:com.zhichenhaixin.proto.TrackPointList.tracks)
  return &tracks_;
}
...
typedef QList<ITF_TrackPoint>                  ITF_TrackPointList;
